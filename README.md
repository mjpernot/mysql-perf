...
### Description: Testing consists of integration testing of functions in the mysql_perf.py program.
...
```
cd test/integration/mysql_perf/config
...
# Integration test runs for mysql_perf.py:
  * Replace **{Python_Project}** with the baseline path of the python program.
...
### Integration:  
```
test/integration/mysql_perf/
```

### All integration testing
```
test/integration/mysql_perf/integration_test_run.sh
```

### Code coverage program
```
test/integration/mysql_perf/code_coverage.sh
```


# Blackbox Testing:

### Description: Testing consists of blackbox testing of the mysql_perf.py program.
...
```
cd test/blackbox/mysql_perf/config
cp ../../../../config/mysql_cfg.py.TEMPLATE mysql_cfg.py
```
...
# Blackbox test runs for mysql_perf.py:
  * Replace **{Python_Project}** with the baseline path of the python program.

```
cd {Python_Project}/mysql-perf
test/blackbox/mysql_perf/blackbox_test.sh
```
